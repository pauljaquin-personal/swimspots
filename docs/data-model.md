...
A spot may include one optional primary `photo` object with `url`, descriptive `alt` text and optional `credit`, `sourceUrl`, `license`, and `licenseUrl` fields. The current UI uses that image in the result card and detail banner, and falls back to the existing generated water artwork when no photo is present or the image fails to load. Where attribution is required, the detail banner links the photographer/source and licence. Photo files should be locally controlled or come from a source with clear publication rights; do not hotlink arbitrary third-party images. Example: `"photo": { "url": "/images/spots/queenstown-bay.jpg", "alt": "Queenstown Bay looking across Lake Whakatipu", "credit": "Photographer name", "sourceUrl": "https://…", "license": "CC BY-SA 4.0", "licenseUrl": "https://creativecommons.org/licenses/by-sa/4.0/" }`.
